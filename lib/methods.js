...
Meteor.methods({
    ...
    getSeriesById: function(id) {
        ...
        console.log('number of season: ' + series.data.number_of_seasons);
        ...
        for (var i=0 ;i< series.data.number_of_seasons; i++) {
            (function(ind) {
                ...
                Meteor.setTimeout(function(){
                    ...
                    console.log('entering the loop ' + current);
    ...
    addSeasonEpisodes: function(params) {
        ...
        console.log('fetching episodes' + season.data.episodes.length);
    ...
    addNewTag: function(tag, series) {

        console.log(tag + ' adding to ' + series);

            // convert all non-words to dashes, trim trailing dash, and lowercase
            var slug = tag.replace(/\W+/g, '-').replace(/\-$/, '').toLowerCase();

            var newTag = Arc.insert({
                title: currentEpisode.name,
                number: currentEpisode.episode_number,
                season: season.data.season_number,
                seriesId: params.seriesId,
...
// https://api.themoviedb.org/3/tv/95/season/1/episode/1?language=en-US&api_key=6d22a3b530e6d0e01197fb9f13b69403
// {"air_date":"1997-03-10","crew":[{"id":12891,"credit_id":"5253387019c2957940053fa5","name":"Joss Whedon","department":"Writing","job":"Writer","profile_path":"/n2x16sVDgj46PabFgJ0jvgjqxWl.jpg"},{"id":1270,"credit_id":"52599e1f19c295731c08a2a2","name":"Charles Martin Smith","department":"Directing","job":"Director","profile_path":"/fahfWqqrdJwajrfEGmEOXQ1p9bm.jpg"}],"episode_number":1,"guest_stars":[{"id":12800,"name":"Carmine Giovinazzo","credit_id":"52599e1f19c295731c08a1e8","character":"","order":11,"profile_path":"/vz4yAF22bqgPWM1ZDzi9OnfzVP2.jpg"},{"id":138323,"name":"Persia White","credit_id":"52599e1f19c295731c08a1b2","character":"","order":10,"profile_path":"/hA9CeUSftHpaWHkL0FAtqYDtLWt.jpg"},{"id":35551,"name":"Julie Benz","credit_id":"52599e1f19c295731c08a188","character":"","order":9,"profile_path":"/3ymRPOitD5IKXZgDLoy8FLRGQCn.jpg"},{"id":34489,"name":"Eric Balfour","credit_id":"52599e1f19c295731c08a134","character":"","order":8,"profile_path":"/vmV5kRoSu4g73ymbt6SSRSIkfKu.jpg"},{"id":57419,"name":"Kristine Sutherland","credit_id":"52599e1f19c295731c08a0e2","character":"","order":7,"profile_path":"/prG40TJKmXr3jo7PQQOy0eebbpD.jpg"},{"id":2719,"name":"Brian Thompson","credit_id":"52599e1e19c295731c08a0b6","character":"","order":6,"profile_path":"/bjBHdq7uPEzrjDk96nNlbDBNKo6.jpg"},{"id":55194,"name":"Mark Metcalf","credit_id":"52599e1e19c295731c08a056","character":"","order":5,"profile_path":"/qjxCggGQH99OkXjDxm33QPIJZcl.jpg"},{"id":51662,"name":"Ken Lerner","credit_id":"52599e1e19c295731c089fdc","character":"","order":3,"profile_path":"/dMkxevvUxdyV3ZL7XidnuM21wUI.jpg"}],"name":"Welcome to the Hellmouth (1)","overview":"Determined for a fresh start, Buffy Summers moves to Sunnydale only to find out that it's located on a Hellmouth and that her slaying duties have just begun.","id":949413,"production_code":null,"season_number":1,"still_path":"/wtat7zAvFxT1UiInXAsgEiOJyCe.jpg","vote_average":0.0,"vote_count":0}